...
public abstract class RowButton {
   ...
   public static void rowButtonMouseClicked(RealmsObjectSelectionList<?> pList, ObjectSelectionList.Entry<?> pEntry, List<RowButton> pButtons, int p_88040_, double p_88041_, double p_88042_) {
      if (p_88040_ == 0) {
