...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   class Entry extends ObjectSelectionList.Entry<RealmsBackupScreen.Entry> {
      ...
      public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean p_283105_, float pPartialTick) {
