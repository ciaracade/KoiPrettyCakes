...
public class WorldLoader {
   ...
   public static <D, R> CompletableFuture<R> load(WorldLoader.InitConfig pInitConfig, WorldLoader.WorldDataSupplier<D> p_214364_, WorldLoader.ResultFactory<D, R> p_214365_, Executor p_214366_, Executor p_214367_) {
      try {
         ...
         return ReloadableServerResources.loadResources(closeableresourcemanager, registryaccess$frozen2, worlddataconfiguration.enabledFeatures(), pInitConfig.commandSelection(), pInitConfig.functionCompilationLevel(), p_214366_, p_214367_).whenComplete((p_214370_, p_214371_) -> {
            if (p_214371_ != null) {
