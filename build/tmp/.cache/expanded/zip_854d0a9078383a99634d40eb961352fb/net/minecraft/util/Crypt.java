...
public class Crypt {
   ...
   private static <T extends Key> T rsaStringToKey(String pKeyBase64, String p_216073_, String p_216074_, Crypt.ByteArrayToKeyFunction<T> pKeyFunction) throws CryptException {
      int i = pKeyBase64.indexOf(p_216073_);
      if (i != -1) {
         i += p_216073_.length();
         int j = pKeyBase64.indexOf(p_216074_, i);
